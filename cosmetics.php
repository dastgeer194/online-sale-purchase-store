...
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $banner_product_category; ?>)">
    <div class="inner">
        <h1><?php echo LANG_VALUE_50; ?> Welcome to Cosmetics</h1>
    </div>
</div>
            ...
            <div class="col-md-12">
                ...
                <div class="coming-soon" style="text-align: center; padding: 100px 0;">
                    ...
                    <p style="font-size: 18px; color: #666; margin-bottom: 30px;">
                        We're preparing beautiful cosmetics and beauty products for you. Our stunning makeup and skincare collection will be launching soon!
                    </p>
                    <div class="countdown" style="font-size: 24px; font-weight: bold; color: #e84393;">
                        Stay Tuned for Beauty Revealed!
                    </div>
                </div>
            </div>
        </div>
