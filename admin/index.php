...
<section class="content">
	<div class="row">
		<div class="col-md-4 col-sm-6 col-xs-12">
			<a href="top-category.php" class="info-box dashboard-card">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<a href="mid-category.php" class="info-box dashboard-card">
				<span class="info-box-icon bg-aqua"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<a href="end-category.php" class="info-box dashboard-card">
				<span class="info-box-icon bg-aqua"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<a href="product.php" class="info-box dashboard-card">
				<span class="info-box-icon bg-aqua"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<a href="order.php?filter=completed-orders" class="info-box dashboard-card">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<a href="order.php?filter=completed-shipping" class="info-box dashboard-card">
				<span class="info-box-icon bg-green"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<a href="order.php?filter=pending-orders" class="info-box dashboard-card">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<a href="order.php?filter=pending-shipping" class="info-box dashboard-card">
				<span class="info-box-icon bg-red"><i class="fa fa-hand-o-right"></i></span>
				<div class="info-box-content">
