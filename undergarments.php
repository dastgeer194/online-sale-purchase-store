...
<div class="page-banner" style="background-image: url(assets/uploads/category-undergarments.jpg)">
    <div class="inner">
        <h1><?php echo LANG_VALUE_50; ?> Welcome to Undergarments</h1>
    </div>
</div>
            ...
            <div class="col-md-12">
                ...
                <div class="coming-soon" style="text-align: center; padding: 100px 0;">
                    ...
                    <p style="font-size: 18px; color: #666; margin-bottom: 30px;">
                        We're working hard to bring you amazing undergarments collection. Please check back later!
                    </p>
